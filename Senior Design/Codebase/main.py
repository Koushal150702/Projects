...
def parse_request():
    try:
        ...
        storage_index = len(list(bucket.list_blobs())) + 41
        ...
        for file in data:
            ...
            img_byte = BytesIO(file.read())
            img_bytes_list.append(img_byte)
            images.append(Image.open(img_byte))
        ...
        for data in grouped_data_to_send:
            ...
            try:
                ...
                firestore_collection['area'] = 'Dubai, United Arab Emirates'
